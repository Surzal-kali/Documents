...
### 2.)  Marlinspike=55 (Apache, Ubuntu 16.04)
        ...
        After checking the system files why yes captain I can read the entire site likes its a maze on a cracker jack box. ITS G-R-E-A-T. We can simply add a user to the  wordpress installation and log in like normal, because the guest account can read the mysql configuration files, and get the credentials for the wordpress, or even reset them.
